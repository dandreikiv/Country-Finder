...
- (MKOverlayPathRenderer *)overlayViewForMapView:(MKMapView *)mapView overlay:(id<MKOverlay>)overlay
{
    MKPolygonRenderer *overlayView = [[MKPolygonRenderer alloc] initWithOverlay:overlay];
